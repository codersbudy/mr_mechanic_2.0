...
function CustomerList() {
  ...
  useEffect(() => {
    let response = axios.get(api.ALL_CUSTOMER);
  ...
  return <>
    <div className='main-dashboard ' >
      <div className="row">
        ...
        {!isLoading &&
          customerList.map((customer, index) => <div className="col-3 ">
            <div className="profilecard ">
              ...
              <div className="mt-3">
                <h3 className="style1">{customer.customerName}</h3>
                <h3 className="style2"> {customer.email}</h3>
                <h3 className="style2"><b>+91 </b>{customer.contact}</h3>
              </div>
              <div className="mt-4">
                <button> Shops </button>
              </div>
