...
function MechanicList() {
  ...
  useEffect(() => {
    let response = axios.get(api.ALL_MECHANIC_LIST);
    response.then((result) => {

      console.log(result);
      setMechanicList(result.data.result);
      setIsLoading(false);
    }).catch((err) => {
      console.log(err)
    });
  ...
  return <>
    <div className='main-dashboard ' >
      <div className="row">
        ...
        {!isLoading &&
          mechanicList.map((mechanic, index) => <div className="col-3 ">
            <div className="profilecard">
              ...
              <div className="mt-3">
                <h3 className="style1">{mechanic.mechanicname}</h3>
                <h3 className="style2"> {mechanic.email}</h3>
                <h3 className="style2"><b>+91 </b>{mechanic.contact}</h3>
              </div>
              <div className="mt-4">
                <button> Shops </button>
              </div>
